...
export default function Clock() {
  ...
  return (
    <div className='float group z-50 flex justify-center max-md:hidden'>
      ...
      <div className='w-fit flex-col'>
        ...
        <div className='flex w-fit opacity-0 group-hover:opacity-100'>
          <div>
          ...
          <div className='h-8 w-40'>
            <p className='rad ml-2 h-8 w-60 overflow-hidden rounded bg-white p-2 pt-0 text-xs text-gray-500 group-hover:h-fit '>
