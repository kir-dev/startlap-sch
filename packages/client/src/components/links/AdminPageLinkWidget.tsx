...
export default function AdminPageLinkWidget(props: Props) {
  ...
  return (
    <div className='flex-no-wrap bg-blue flex w-80 flex-col items-center overflow-hidden rounded-xl p-2'>
